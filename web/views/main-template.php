...
<meta name="google-site-verification"
	content="SpPluYndV5P2YiWsUIPdFRq5eJoHln-80g3c97Hnn30" />
...
echo $url?>/web/public/images/school-banner.jpg">
...
<link rel="stylesheet" as="style"
	href="<?php echo $servername ?>/web/public/css/owl.carousel.min.css">
<link rel="stylesheet" as="style"
	href="<?php echo $servername ?>/web/public/css/owl.theme.default.min.css">
...
<script src="<?php echo $servername ?>/web/public/js/owl.carousel.min.js"></script>
<script type="text/javascript"
	src="<?php echo $servername ?>/web/public/js/config.js"></script>
<script data-ad-client="ca-pub-5150059101517419" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
...
<body oncontextmenu="return false">
	...
	<footer class="bottom-foot-container">
			<div class="container">
				...
				<div class="col-md-3">
						<div class="header">
							<a class="faq-link" href="<?php echo $servername ?>/faq">Giải đáp
								thắc mắc</a>
						</div>
					</div>
					<div class="col-md-3">
						<div class="header">
							<a class="tnc-link" href="<?php echo $servername ?>/tnc">Điều
								khoản sử dụng</a>
						</div>
					</div>
					<div class="col-md-3">
